...
export const saveNote = {
    ...
    DELETE_SCRIBBLE: 'DELETE_SCRIBBLE',
...
export const notifications = {
    ...
    MARK_SHARED_NOTES_AS_SEEN_SUCCESS: 'MARK_SHARED_NOTES_AS_SEEN_SUCCESS',
    MARK_SHARED_NOTES_AS_SEEN_FAIL: 'MARK_SHARED_NOTES_AS_SEEN_FAIL',
    RESPOND_TO_SHARED_NOTE_SUCCESS: 'RESPOND_TO_SHARED_NOTE_SUCCESS',
    RESPOND_TO_SHARED_NOTE_FAIL: 'RESPOND_TO_SHARED_NOTE_FAIL',
}
